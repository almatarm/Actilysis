...
class ActilysisController
{
    ...
    function save() {
        ...
        WatchUi.pushView(new WatchUi.ProgressBar("Saving...", null), new ActilysisProgressDelegate(), WatchUi.SLIDE_DOWN);
    ...
    function discard() {
        ...
        // and start a timer to allow all processing to finish
        WatchUi.pushView(new WatchUi.ProgressBar("Discarding...", null), new ActilysisProgressDelegate(), WatchUi.SLIDE_DOWN);
        mTimer = new Timer.Timer();
        mTimer.start(method(:onExit), 3000, false);
    }
